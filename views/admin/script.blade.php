<script defer>
    function badgeProductGeneralSubmit(element) {
        ...
        data.action = 'ProductBadge\\Ajax\\Admin\\ProductBadgeAjax::generalSave';
    ...
    class BadgeProductHandler {
        ...
        loadForm() {
            ...
            let data = {
                action: 'ProductBadge\\Ajax\\Admin\\ProductBadgeAjax::styleLoad',
                style: this.styleId,
        ...
        styleSave(element) {
            ...
            data.action = 'ProductBadge\\Ajax\\Admin\\ProductBadgeAjax::objectSave';
...
<style>
    <?php include \SkillDo\Support\Path::plugin('badge-management/assets/css/style.admin.css'); ?>
</style>